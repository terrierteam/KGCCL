...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs="?", type=str,default='amazon-book',
                        help="available datasets: [lastfm, gowalla, yelp2018, amazon-book, MIND ,LAS, ALB]")
    ...
    parser.add_argument('--model', type=str, default='kgcl', help='rec-model, support [kgcl]')
    parser.add_argument("--data_path", nargs="?", default="data/", help="Input data path.")
    parser.add_argument("--inverse_r", type=bool, default=True, help="consider inverse relation or not")
    parser.add_argument('--dim', type=int, default=64, help='GCN embedding size')
